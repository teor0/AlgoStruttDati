...
public class Tester {	
	 ...
	 * hanno un valore che è uguale alla somma dei 
	 * valori contenuti nel loro sottoalbero sinistro 
	 * più la somma dei valori contenuti
...
//				verificaSomma(a.des());
		...
		return verificaSomma(a.sin()) && (((Integer) a.val()).intValue()==somma(a.sin()) +somma(a.des())) 
		&& verificaSomma(a.des());
	 ...
	 * che si trovano al livello liv hanno valore 0; la radice � al livello 0;
	 */
