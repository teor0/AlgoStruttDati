...
public abstract class Grafo<A extends Arco> {
	...
	public abstract Iterator<A> archi();//MATRICE: theta(n^2)  //iteratore su tutti gli archi
										//LISTA: theta(n+m)
	
	public abstract Iterator<A> adiacenti(int v); 	//MATRICE: theta(n) //iteratore su gli archi uscenti da v
													//LISTA: theta(gout(v))
